...
class TelegramUpdateHandler
{
    ...
    public function handle(array $update): ?array
    {
        ...
        return $this->reply(
            $chatId,
            'Проверка #'.$investigation->id.' поставлена в очередь. Я буду присылать этапы сюда. Текущий статус также можно запросить командой /status.',
        );
    }
    ...
    private function reply(int $chatId, string $text): array
    {
        return [
            'chat_id' => $chatId,
