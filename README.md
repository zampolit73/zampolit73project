...
- публичный читательский дневник в виде книжной полки с локальными оценками и заметками;
...
| `/projects/reading-diary` | публичный | личная книжная полка с оценками, датами и заметками; данные хранятся в браузере |
| `/login` | гость | вход |
