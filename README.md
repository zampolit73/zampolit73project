...
- внутренний каталог публичных презентаций ИТ-директоров: TAdviser, CNews, 4CIO/ОКИТ и ИТ-Диалог; прямые ссылки и презентации в Яндекс Диске без хранения файлов;
